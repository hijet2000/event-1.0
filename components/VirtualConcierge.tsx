            ...
            try {
                ...
                const sessionPromise = ai.live.connect({
                    ...
                    config: {
                        ...
                        systemInstruction: { parts: [{ text: eventContext }] },
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center sm:p-4 pointer-events-none">
            ...
            <div className="relative bg-white dark:bg-gray-900 w-full sm:max-w-md rounded-t-2xl sm:rounded-2xl shadow-2xl p-6 pointer-events-auto overflow-hidden">
                ...
                <div className="space-y-4 min-h-[100px] max-h-[150px] overflow-y-auto p-4 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 mb-6">
                    {transcript.user && (
